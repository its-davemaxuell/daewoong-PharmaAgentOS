    ...
    async def generate_translation(
        ...
        *,
        ...
        system_instruction = (
            ...
            "Use consistent pharmaceutical Korean across all units: quality unit (QU) = "
            "품질부서(QU); quality control unit = 품질관리부서; your firm/you = 귀사; "
            "FDA facility inspection = FDA 실사; out-of-specification (OOS) = 규격 일탈(OOS); "
            "residue on ignition = 강열잔분; attributable records = 작성자를 식별할 수 있는 기록; "
            "contemporaneous records = 작업 시점에 작성된 기록. A CFR 'part' is a 법규 편, "
            "never a physical 부품; retain CFR part references such as 'parts' beside immutable "
            "citations if necessary. Render absence of robust governance as 견고한 관리 체계의 "
            "부재, without a double negative. Do not add awkward English fragments inside "
            "parentheses: use an exact source term only when it helps clarify the Korean. "
