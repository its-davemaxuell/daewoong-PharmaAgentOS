---
version: 1
slug: "apps-web-app-portal-examples-page-tsx"
primary_target: "apps/web/app/(portal)/examples/page.tsx"
related_targets: ["apps/web/app/(portal)/examples/[slug]/page.tsx","apps/web/components/examples/examples-gallery.tsx","apps/web/components/examples/example-detail.tsx"]
---
...
fixture grading and deterministic checks do not imply independent human approval.
The final reference artifact remains a draft. Preserve these notices in copied and
downloaded results. Examples startup preparation imports the component without
requesting a nonexistent menu API.
